...
from src.microsoft_sentinel_intel_connector.api_handler import SentinelApiHandler
from src.microsoft_sentinel_intel_connector.config_variables import ConfigConnector
